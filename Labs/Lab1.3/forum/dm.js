...
var publicMessages = {
  id0: [
    new Post("primer mensaje", "Foreador", new Date()),
...
exports.addPrivateMessage = function(msg) {
  ...
  var u2 = msg.to;
  var k =
    u1.toLowerCase().localeCompare(u2.toLowerCase()) < 0
      ? u1 + "_" + u2
      : u2 + "_" + u1;
